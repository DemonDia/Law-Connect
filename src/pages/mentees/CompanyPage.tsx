...
import { createApplication, getUserApplications } from "../../helperFunctions/firebase/applicationFunctions"
								...
								{selectedTab == 0 ? (
									<>
										...
										{applications.map((application: any) => {
											const { companyId, companyName, outcome, applicationDate, id } = application
											return (
									...
									<>
										{companies.map((company: any) => {
											const found: any = applications.find((application: any) => {
												return application.companyId === company.userId
											})
